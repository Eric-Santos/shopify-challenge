      ...
      <Card.Group centered>
        <Card fluid>
          ...
          <Card.Content extra onClick={handleClick}>
            ...
            {isLiked ?
              <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>< Icon name='like'/></motion.button> : <motion.button whileHover={{ scale: 1.1 }}
    whileTap={{ scale: 0.9 }}><Icon name='cancel'/></motion.button>
            }
          </Card.Content>
        </Card>
      </Card.Group>
